...
# NOTICE: THIS METHOD IS NOW OBSOLETE AND DEPRECIATED! THERE IS A NEW AND IMPROVED GUIDE.
...
**<details><summary>GitHub Desktop</summary>**
...
- You can skip this step if you did the GitHub Desktop install above. <sup>[1](https://github.com/ctrlxcvz/sd-guides/blob/main/krita-sd-local.md#optional-install)</sup>
