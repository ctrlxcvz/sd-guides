...
- You can skip this step if you did the GitHub Desktop Pre-Req above. <sup>[1]https://github.com/ctrlxcvz/sd-guides/blob/main/krita-sd-local.md#-do-this-following-step-only-if</sup>
